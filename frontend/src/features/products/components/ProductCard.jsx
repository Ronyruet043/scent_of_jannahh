...
//     const wishlistItems = useSelector(selectWishlistItems) || []; // Default to empty array
...
//         (item) => item?.product?._id === id // Use optional chaining to avoid errors
//       );
