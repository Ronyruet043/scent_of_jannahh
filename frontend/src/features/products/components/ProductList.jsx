...
import {banner1,ator1,ator2,ator3,ator5,ator6, banner2, banner3, banner4, loadingAnimation} from '../../../assets'
...
const bannerImages=[ator1,ator2,ator5,ator6]
...

    {
        ...
        <motion.div style={{position:"fixed",backgroundColor:"white",height:"100vh",padding:'1rem',overflowY:"scroll",width:is500?"100vw":"30rem",zIndex:500}}  variants={{show:{left:0},hide:{left:-500}}} initial={'hide'} transition={{ease:"easeInOut",duration:.7,type:"spring"}} animate={isProductFilterOpen===true?"show":"hide"}>
            ...
            <Stack mb={'5rem'}  sx={{scrollBehavior:"smooth",overflowY:"scroll"}}>
                    ...
                    <Stack rowGap={2} mt={4} >
                        <Typography sx={{cursor:"pointer"}} variant='body2'>Rose attar</Typography>
                        <Typography sx={{cursor:"pointer"}} variant='body2'>Sandalwood attar</Typography>
                        <Typography sx={{cursor:"pointer"}} variant='body2'>Jasmine attar</Typography>
                        <Typography sx={{cursor:"pointer"}} variant='body2'>Mukhallat attar</Typography>
                        <Typography sx={{cursor:"pointer"}} variant='body2'>Islamic Bakhoor Attar</Typography>
                    </Stack>
...
//                 <Stack sx={{ width: "100%", height: is800 ? "400px" : is1200 ? "600px" : "700px" }}>
//   <ProductBanner images={bannerImages} />
// </Stack>
                }
                    ...
                    {/* <Grid gap={is700?1:2} container justifyContent={'center'} alignContent={'center'}>
                        {
                            ...
                            <Grid container gap={2} justifyContent={'center'} alignContent={'center'}>
  {products && products.length > 0 ? (
    products
      .filter(product => product && product._id) // Exclude invalid products
      .map(product => (
        <ProductCard
          key={product._id}
          id={product._id}
