...
import FontVideo from '../../../assets/images/FontVideo.mp4';
...
export const Login = () => {
  ...
  return (
    <Stack width={'100vw'} height={'100vh'} flexDirection={'row'} sx={{overflowY:"hidden"}}>
        ...
        // </Stack> 
        <Stack Stack bgcolor={'black'} flex={1} justifyContent={'center'}  flexDirection={'row'}  alignItems={'center'}>
        <Stack rowGap={'.4rem'} alignItems={'center'}>
          ...
          {/* Optional: Keep the text as a subtitle or remove it */}
          <Typography alignSelf={'flex-end'} color={'GrayText'} variant='body2'>
            - Be Refresh With Fragrance
          </Typography>
        </Stack>
      </Stack>
        ...
        <Stack flex={1} justifyContent={'center'} alignItems={'center'}>
              ...
              <Stack flexDirection={'row'} justifyContent={'center'} alignItems={'center'}>
                ...
                <Stack rowGap={'.4rem'}>
                  <Typography variant='h2' sx={{wordBreak:"break-word"}} fontWeight={600}>Scent Of Al Jannah</Typography>
                  <Typography alignSelf={'flex-end'} color={'GrayText'} variant='body2'>- Be Refresh With Fragrance</Typography>
                </Stack>
